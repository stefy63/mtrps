<div class="row padding-1 p-1">
    <div class="col-md-6">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <select name="car_owner_id" class="form-control @error('car_owner_id') is-invalid @enderror" id="car_owner_id">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <select name="car_brand_id" class="form-control @error('car_brand_id') is-invalid @enderror" id="car_brand_id">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <select name="car_power_id" class="form-control @error('car_power_id') is-invalid @enderror" id="car_power_id">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <select name="car_profit_account_id" class="form-control @error('car_profit_account_id') is-invalid @enderror" id="car_profit_account_id">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $car?->name) }}" id="name" placeholder="Nome veicolo">
            {!! $errors->first('name', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        
        <div class="form-group mb-2 mb20">
            <label for="model" class="form-label">{{ __('Modello') }}</label>
            <input type="text" name="model" class="form-control @error('model') is-invalid @enderror" value="{{ old('model', $car?->model) }}" id="model" placeholder="Modello">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="color" class="form-control @error('color') is-invalid @enderror" value="{{ old('color', $car?->color) }}" id="color" placeholder="Colore">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="cod_model" class="form-control @error('cod_model') is-invalid @enderror" value="{{ old('cod_model', $car?->cod_model) }}" id="cod_model" placeholder="Codice modello">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="profit_account" class="form-control @error('profit_account') is-invalid @enderror" value="{{ old('profit_account', $car?->profit_account) }}" id="profit_account" placeholder="Conto profitto">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="number" name="tank" class="form-control @error('tank') is-invalid @enderror" value="{{ old('tank', $car?->tank) }}" id="tank" placeholder="Capacità serbatoio in litri" min="0">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="number" name="km" class="form-control @error('km') is-invalid @enderror" value="{{ old('km', $car?->km) }}" id="km" placeholder="Chilometri percorsi" min="0">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <div class="form-check">
                ...
                <input type="checkbox" name="winter_wheels" class="form-check-input @error('winter_wheels') is-invalid @enderror" value="1" id="winter_wheels" {{ old('winter_wheels', $car?->winter_wheels) ? 'checked' : '' }}>
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="wheels_type" class="form-control @error('wheels_type') is-invalid @enderror" value="{{ old('wheels_type', $car?->wheels_type) }}" id="wheels_type" placeholder="Tipo pneumatici">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="warranty" class="form-control @error('warranty') is-invalid @enderror" value="{{ old('warranty', $car?->warranty) }}" id="warranty" placeholder="Informazioni garanzia">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="tel_warranty" class="form-control @error('tel_warranty') is-invalid @enderror" value="{{ old('tel_warranty', $car?->tel_warranty) }}" id="tel_warranty" placeholder="Numero assistenza">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="chassis" class="form-control @error('chassis') is-invalid @enderror" value="{{ old('chassis', $car?->chassis) }}" id="chassis" placeholder="Numero telaio">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="date" name="date_revision" class="form-control @error('date_revision') is-invalid @enderror" value="{{ old('date_revision', $car?->date_revision) }}" id="date_revision">
    ...
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="date" name="doc" class="form-control @error('doc') is-invalid @enderror" value="{{ old('doc', $car?->doc) }}" id="doc">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="description" class="form-control @error('description') is-invalid @enderror" value="{{ old('description', $car?->description) }}" id="description" placeholder="Descrizione veicolo">
            {!! $errors->first('description', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        
        <div class="form-group mb-2 mb20">
            <label for="note" class="form-label">{{ __('Note') }}</label>
            <textarea name="note" class="form-control @error('note') is-invalid @enderror" id="note" rows="3" placeholder="Note aggiuntive">{{ old('note', $car?->note) }}</textarea>
