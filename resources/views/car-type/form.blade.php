<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $carType?->name) }}" id="name" placeholder="Nome tipologia veicolo (es. Berlina, SUV, Furgone)">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="description" class="form-control @error('description') is-invalid @enderror" value="{{ old('description', $carType?->description) }}" id="description" placeholder="Descrizione della tipologia">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <textarea name="note" class="form-control @error('note') is-invalid @enderror" id="note" rows="4" placeholder="Note aggiuntive sulla tipologia">{{ old('note', $carType?->note) }}</textarea>
