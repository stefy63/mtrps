...
<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-floating mb-2 mb20">
            <input type="text" name="ente" class="form-control @error('ente') is-invalid @enderror"
                   value="{{ old('ente', $office?->ente) }}" id="ente" placeholder="Ente">
        ...
        <div class="form-floating mb-2 mb20">
            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                   value="{{ old('name', $office?->name) }}" id="name" placeholder="Name">
            <label for="name" class="form-label">{{ __('Name') }}</label>
            {!! $errors->first('name', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-floating mb-2 mb20">
            <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror"
                   value="{{ old('phone', $office?->phone) }}" id="phone" placeholder="Phone">
            <label for="phone" class="form-label">{{ __('Phone') }}</label>
            {!! $errors->first('phone', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-floating mb-2 mb20">
            <input type="text" name="mail" class="form-control @error('mail') is-invalid @enderror"
                   value="{{ old('mail', $office?->mail) }}" id="mail" placeholder="Mail">
