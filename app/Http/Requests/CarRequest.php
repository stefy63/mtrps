...
class CarRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'car_police_plate_id'  => 'nullable|exists:car_plates,id',
            'car_civil_plate_id'  => 'nullable|exists:car_plates,id',
            'car_origin_plate_id'  => 'nullable|exists:car_plates,id',
            ...
            'assignee_id' => 'integer|nullable|exists:offices,id',
